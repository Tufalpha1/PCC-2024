...
const Banner = () => {
  return (
      <div className="relative isolate top-24 sm:mb-32 flex items-center gap-x-6 overflow-hidden text-white bg-gradient-to-r from-[#aa0000] to-[#91221E] px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
            <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
              <p className="text-sm leading-6 text-white">
                ...
                Registration ends on 30th September 2024.
              </p>
